...
INSERT INTO Service_history_table(service_history_id, service_id, customer_id, vehicle_id, mechanic_id, date_start, date_end, 
description_of_service, total_cost, service_rating)
VALUES
(1, 1, 1, 1, 1, '2024-11-13', NULL, 'Needs oil change', 1200.00, 10), 
(2, 2, 2, 2, 2, '2024-11-14', NULL, 'Needs to replace breaks', 8001, 10),
(3, 3, 3, 3, 3, '2024-11-15', NULL, 'Needs to replace battery', 6201.15, 10),
(4, 4, 4, 4, 4, '2024-11-16', NULL, 'Needs to change tires', 18800.00, 10),
(5, 5, 5, 5, 5, '2024-11-17', NULL, 'Needs to check engine', 11000.00, 10);
